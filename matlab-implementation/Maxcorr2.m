% Classificador de Maxima Correlacao Robusto (com Centroide calculado pela mediana)
...
for r=1:Nrep,   % inicio do loop de repeticoes
  ...
  for k=1:C,
    ...
    M{k}=median(Xtrn(:,I),2);   % Calcula o centroide do subconjunto de vetores da classe k
